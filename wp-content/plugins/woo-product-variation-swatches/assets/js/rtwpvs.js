(function ($) {
  ...
  $.fn.rtWpvsVariationSwatchesForm = function () {
    ...
    this.start = function () {
      ...
      this._variation_form.find('.rtwpvs-terms-wrapper').each(function () {
        ...
        attribute.on('touchstart click', '.rtwpvs-term:not(.rtwpvs-radio-term)', function (e) {
          ...
          if (is_selected && rtwpvs.reselect_clear) {
            term = '';
    ...
    this.update_trigger = function () {
      ...
      this._variation_form.on('found_variation', function (event, variation) {
        var _this = this;

        if (rtwpvs.disable_out_of_stock) {
          _.delay(function () {
            $(_this).find('.rtwpvs-terms-wrapper').each(function () {
              var attribute_name = $(this).data('attribute_name') || $(this).attr('data-attribute_name');
              $(this).find('.rtwpvs-term').each(function () {
                var value = $(this).data('term') || $(this).attr('data-term');
