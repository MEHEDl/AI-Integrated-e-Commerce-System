...
[Product Table WooCommerce plugin](https://woobewoo.com/plugins/table-woocommerce-plugin/?utm_source=wordpress&utm_medium=description&utm_campaign=wooproducttable "Product Table WooCommerce plugin") allows do a lot of cool things with WooCommerce that wouldn’t otherwise be possible.
Make tables of your product in a few minutes! Responsive effective table of the selected products will be created automatically due to your requirements. Add a caption, sorting, searching, pagination and other options to your product table in one click. 
...
Just one click - and your products uploaded in a product table.
...
Plugin fully supports variable products. You can display variations as dropdown lists, together with attribute and category filters. It makes the selection of the necessary products incredibly flexible and fast.

* **[Add to cart button](https://woobewoo.com/feature/quantities-and-multiple-add-to-cart?utm_source=wordpress&utm_medium=addtocart&utm_campaign=wooproducttable "Add to cart")**
Customers can choose the quantity and add products directly to the cart.
...
Display add to cart buttons and multi-select checkboxes to let customers select several products and buy easily.
...
Enter your keywords and perform an instant search. Sort data rows an exact order you need.  Provide users better navigation increasing the user experience.

* **[Product Table design](https://woobewoo.com/documentation/appearance-settings/?utm_source=wordpress&utm_medium=design&utm_campaign=wooproducttable "Appearance settings")** 
Play with settings to find your own style and make your page unique with a variation of options. Tones of additional design settings with Custom table styling tab **.
...
Keep the nice and proper view of your page, which is adapted to the screen dimensions and works properly on a range of any devices.
...
Plugin fully supports: Name, Thumbnails, Categories, Featured, Price, Date, SKU, Rating, Stock status, Attributes **, Summary, Short description, Buy button.
* **[Compatibility with Advanced Custom Fields (ACF)](https://woobewoo.com/example/custom-fields/ "Custom Fields")** **
Create any custom fields for your products – image, text, video, link, button, taxonomy, map etc and display them as columns in a table.

* **[Filter by attributes and categories](https://woobewoo.com/example/more-demos?utm_source=wordpress&utm_medium=filters&utm_campaign=wooproducttable "Filter by attributes and categories")** **
Product Table has built-in filters for category and attributes, which can be added like a drop-down menu above the table.
...
4. Select and add columns to the table: Name, Thumbnails, Categories, Featured, Price, Color, Size, Customizable, Date, SKU, Rating, Stock status, Attribute, Summary, Buy button
...
2. WooCommerce Product Table WordPress plugin admin area. Table columns
3. WooCommerce Product Table WordPress plugin admin area. Content settings
4. WooCommerce Product Table WordPress plugin admin area. Main
5. WooCommerce Product Table WordPress plugin admin area. Features
6. WooCommerce Product Table WordPress plugin admin area. Appearance
7. WooCommerce Product Table example on a website
